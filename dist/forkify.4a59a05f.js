...
var _config = require("./other js/config");
...
const init = function() {
    ...
    (0, _recipeViewsDefault.default).addHandlerUpdateService(controlServings);
...
},{"./model":"3QBkH","./views/recipeViews":"eC0AB","./views/searchView":"kbE4Z","./views/resultsView":"kBQ4r","./views/paginationView":"7NIiB","./views/bookmarksView":"1qGeA","./views/addRecipeView":"8AWnP","./other js/config":"k0ok2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"3QBkH":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
var _config = require("./other js/config");
// import { getJSON, sendJSON } from './other js/helper';
var _helper = require("./other js/helper");
const state = {
    recipe: {},
    search: {
        query: '',
...
const loadRecipe = async function(id) {
    try {
        ...
        // creating a simplified recipe info object from api
        state.recipe = createRecipeObject(data);
        //Add bookmarked property to recipe object
...
const deleteBookmark = function(id) {
    ...
    //Update after removing bookmark
    persistBookmarks();
};
const init = function() {
...
init();
//Just for safety, not implemented
...
},{"regenerator-runtime":"f6ot0","./other js/config":"k0ok2","./other js/helper":"atnqv","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"f6ot0":[function(require,module,exports,__globalThis) {
/**
...
},{}],"k0ok2":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const KEY = 'df1ccfac-73f5-4f25-b196-dfad84c9c8ab';
...
},{}],"atnqv":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./config":"k0ok2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"eC0AB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class RecipeView extends (0, _viewDefault.default) {
    ...
    // Handles changes in id when loaded or change in recipe id
    ...
    //Handles servings ie, update servings and performs calculation function (handler)
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (curPage === 1 && numPages > 1) return this._generateMarkupButton(curPage, true);
        //Last page
        if (curPage === numPages && numPages > 1) return this._generateMarkupButton(curPage, false);
        //Other page
    ...
    _generateMarkupButton(curPage, isNextPage) {
        ...
        return `
    <button data-goto="${dataGoTo}" class="btn--inline ${isNextPage ? 'pagination__btn--next' : 'pagination__btn--prev'}">
      <svg class="search__icon">
        <use href="${0, _iconsSvgDefault.default}${isNextPage ? '#icon-arrow-right' : '#icon-arrow-left'}"></use>
      </svg>
...
class BookmarksView extends (0, _viewDefault.default) {
    ...
    _errorMessage = 'No bookmarks yet . Find your favorite recipe ';
    _message = '';
    addHandlerRender(handler) {
